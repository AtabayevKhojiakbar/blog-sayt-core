...
//    $str = explode(".",$array['text']);
    ...
    for($i=0;$i<strlen($array['text']);$i++){
        if($array['text'][$i]==".") $k++;
        if($k==2){
            $text[]=substr($array['text'],$m,$i+1-$m);
            $k=0;
            $m=$i+2;
        }
    }
...
<!--                 End        about================================-->
                        <span class="post-date"><?=$array['created_at'];?></span><span class="dot"></span><span class="post-read">6 min read</span>
                    </div>
                </div>
                <!-- End Top Menta -->

<!--Begin  title=================-->
                <h1 class="posttitle"><?=$array['title'];?></h1>
<!--End  title===================-->

            </div>

            <!-- Begin Featured Image -->
            <img class="featured-image img-fluid" src="<?=$array['img']?>" alt="Bu yerda img turadi">
            <!-- End Featured Image -->
