...
<!--                        <h2 class="card-title"><a href="post.php">Life is worth living forever and ever</a></h2>-->
...
<!--                    </a>-->
<!--                    <div class="card-block">-->
<!--                        <h2 class="card-title"><a href="post.php">Best European capitals to visit and the costs implied</a></h2>-->
<!--                        <h4 class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</h4>-->
<!--                        <div class="metafooter">-->
<!--                            <div class="wrapfooter">-->
<!--		              <span class="meta-footer-thumb">-->
...
<!--                    </a>-->
<!--                    <div class="card-block">-->
<!--                        <h2 class="card-title"><a href="post.php">10 Things you should learn before visiting</a></h2>-->
<!--                        <h4 class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</h4>-->
<!--                        <div class="metafooter">-->
<!--                            <div class="wrapfooter">-->
<!--		              <span class="meta-footer-thumb">-->
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi blanditiis commodi, distinctio doloremque dolorum ea exercitationem illum, laudantium magnam maxime minima nemo neque nesciunt numquam praesentium reprehenderit saepe similique sint ullam voluptatum? Eos, incidunt quae. Aliquid, amet aperiam, asperiores atque aut autem cupiditate debitis et harum illo, illum ipsum itaque molestiae nam necessitatibus non nulla officia officiis optio perspiciatis placeat qui repudiandae sapiente sed voluptatibus! Aliquam eos et fugit ipsa ipsam itaque magni odit omnis perferendis, quasi! Ad aspernatur assumenda at, commodi cum debitis excepturi exercitationem facere fugiat inventore iusto officiis praesentium quia rem rerum saepe tempore vitae voluptatibus voluptatum!